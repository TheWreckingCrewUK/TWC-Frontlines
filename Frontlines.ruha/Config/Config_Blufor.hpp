...
class Blufor_Setup {
	...
	AW_bluforLightVehicles[] = {
		...
		{"CUP_B_Dingo_GL_GER_Wdl", {200,50,200}, ""},								//Dingo
		{"CUP_B_Dingo_GER_Wdl", {200,50,200}, ""},			
		
		{"CUP_B_FENNEK_GER_Wdl", {100,25,100}, ""},									//Fennek

		{"UK3CB_BAF_MAN_HX60_Cargo_Green_A", {100,100,0}, ""},                      // MAN 4x4
		{"UK3CB_BAF_MAN_HX60_Transport_Green", {100,100,0}, ""},
		
		{"CUP_B_MTVR_Ammo_BAF_WOOD", {100,100,0}, ""},								// MTVR Ammo Truck
	...
	AW_bluforHeavyVehicles[] = {
		{"CUP_B_M113A3_GER", {200,150,200}, ""}, //

		{"CUP_B_Boxer_GMG_GER_WDL", {300,200,200}, ""},
		{"CUP_B_Boxer_HMG_GER_WDL", {300,200,200}, ""},

		{"CUP_B_Leopard2A6_GER", {600,400,600}, ""}
	};
	...
	AW_supplyCrates[] = { //format {"category","title","box size",{resources},{contents}}
		{"medicalCrateCategory","Small Medical Crate","medical",{25,0,0},{
			...
			{"ACE_salineIV_500",8},
			{"ACE_salineIV_250",10},
			{"TWC_Item_Medical_SutureKit_25",5}
		}},
		{"medicalCrateCategory","Large Medical Crate","medical",{75,0,0},{
		...
		{"lightWeaponCrateCategory","Gruppe Resupply","medium",{50,0,0},{
